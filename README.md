...
<body>
    ...
    <div class="right-side d-none d-lg-block">
      ...
      <div class="social-box">
        ...
        <div class="social d-none d-lg-block">
          <a href="https://www.tiktok.com/@hydra98x">
            <i class="bi bi-tiktok t-black red"></i>
          </a>
          <a href="https://facebook.com/myprofile.98.75">
            <i class="bi bi-facebook t-blue"></i>
          </a>
          <a href="+84 869937852">
            <i class="bi bi-phone t-green"></i>
          </a>
        </div>
      </div>
    ...
    <div class="left-side  nav-close">
      <div class="menu-content-align">
        ...
        <h1 class="mt-1">Nguyễn Hồng Sơn</h1>
        ...
        <div class="container d-lg-none d-inline-block">
          <div class="row">
            <div class="col-12 text-center">
              <p class="text-muted mb-0">Nguyen Hong Son DESIGNER</p>
            </div>
          </div>
        </div>
      </div>
    ...
    <main id="main" class="main-2">
      ...
      <section id="hero" class="section hero w-100">
            ...
            <div class="row">
              <div class="col-lg-12 text-center text-lg-start">
                ...
                <div class="hero-content mt-4 mx-auto mx-lg-0 text-lg-left mt-lg-none">
                  <p class="base-color">Nguyen Hong Son DESIGNER</p>
                  <h2>Tôi Là <span class="text  sec-text base-color">Animation Coding </span></h2>
                  <h2>Chào Mừng Đến Với Thế Giới Của Tôi </h2>
                </div>
        ...
        <div class="hero-footer d-block d-lg-none">
          <a class="download-cv primary-button mt-3 mb-4 d-lg-none" href="javascript:void(0);">CV ONLINE</a>
            ...
            <div class="row">
              ...
              <div class="col-lg-7">
                <div class="about-description">
                  <h3 class="mb-3">Một câu chuyện ngắn về tôi, sứ mệnh, suy nghĩ và nghề của tôi.</h3>
                  <p class="about-text">Đời lập trình của tôi bắt đầu bằng sự tình cờ ...
                    meliodas là biệt danh đầu tiên và cũng là duy nhất của mình. Khi còn là cậu học sinh lớp 10 ngu ngơ, mình đã gặp anh Quang. Người đã thay đổi cuộc đời mình theo chiều hướng tích cực hơn. Biến mình từ thằng mọt sách không biết sử dụng máy tính trở thành một lập trình viên như hôm nay. Được tự hào kể lại câu chuyện và tự hào vì là một thành viên chân thành tại ..... Mình thực sự rất hạnh phúc khi học tập và làm việc tại đây.</p>
                </div>
                <!-- Personal Info -->
                <div class="row">
                  <div class="col-lg-6">
                    <ul class="list-unstyled personal-info">
                      ...
                      <li>Phone : <small>+84 869937852</small>
                      </li>
                      <li>City : <small>Thai Nguyen, Viet Nam</small>
                      </li>
                    </ul>
                  </div>
                  <div class="col-lg-6">
            ...
            <div class="row pt-5">
              <div class="col-lg-7">
                <div class="skill-description">
                  <h3 class="mb-3">Tôi đã có thể trải nghiệm và phát triển loại kỹ năng này.</h3>
                  <p class="mb-0">Tôi đã làm mọi thứ trong khả năng của mình để cung cấp cho tôi tất cả kinh nghiệm nhằm cung cấp các sản phẩm chất lượng cao và hiệu quả về chi phí để làm hài lòng khách hàng của tôi trên toàn thế giới</p>
                </div>
              </div>
              <div class="col-lg-5">
          ...
          <div class="testimonial mt-5">
            <div class="owl-carousel">
              ...
              <div class="testimonial-box">
                <p class="testimonial-comment">"Động lực của tôi là sự hài lòng của khách hàng. Hãy tin tưởng tôi và tin tưởng vào khả năng quản lý tài sản tăng trưởng của bạn đối với chuyên môn của tôi đã đạt được trong nhiều năm. Mục tiêu của tôi là thành tích liên tục.!"</p>
                ...
                <div class="col-md-6">
                  <div class="services-box">
                    ...
                    <div class="services-content">
                      ...
                      <p class="services-description mb-0">Trong bối cảnh nghề nghiệp, thường xảy ra trường hợp các khách hàng tư nhân hoặc doanh nghiệp yêu cầu thực hiện một ấn phẩm.</p>
                    </div>
                  </div>
                </div>
                <!-- Item 02 -->
                ...
                <div class="col-md-6">
                  <div class="timeline-box">
                    <div class="time-line-header">
                      <p class="timeline-year">2016 - 2023</p>
                      <h6 class="timeline-title">Đại Học Thái Nguyên</h6>
                    </div>
                    <div class="timeline-content">
                      <p>LBản thân cơn đau rất quan trọng, nó sẽ theo sau nó là tinh hoa mỡ. Mỗi chủ đề không chỉ là nền mà còn là một yếu tố của thiết kế web.</p>
                    </div>
                  </div>
                </div>
                <!--  Item 02  -->
              ...
              <div class="col-md-6">
                <a href="webdesigner-blog-singel-colorfull.html" class="blog-box">
                  ...
                  <div class="blog-post-content">
                    ...
                    <h6 class="blog-header">Được thông báo về các hình ảnh mới nhất và tiền của điều đó</h6>
                    <p class="mb-0">Bản thân công ty hỗ trợ khách hàng rất nhiều nhưng cũng đến lúc chúng xảy ra như vậy.</p>
                  </div>
                </a>
              </div>
              <!-- Item 02 -->
              <div class="col-md-6">
                <a href="webdesigner-blog-singel-colorfull.html" class="blog-box">
                  ...
                  <div class="blog-post-content">
                    ...
                    <h6 class="blog-header">Tài nguyên nào giúp bạn chụp ảnh</h6>
                    <p class="mb-0">Bản thân công ty hỗ trợ khách hàng rất nhiều nhưng cũng đến lúc chúng xảy ra như vậy.</p>
                  </div>
                </a>
              </div>
              ...
              <div class="col-md-6">
                <a href="webdesigner-blog-singel-colorfull.html" class="blog-box">
                  ...
                  <div class="blog-post-content">
                    ...
                    <h6 class="blog-header">Cải thiện kỹ năng của bạn với các bài đăng trên blog về nhiếp ảnh</h6>
                    <p class="mb-0">Bản thân công ty hỗ trợ khách hàng rất nhiều nhưng cũng đến lúc chúng xảy ra như vậy.</p>
                  </div>
                </a>
              </div>
              ...
              <div class="col-md-6">
                <a href="webdesigner-blog-singel-colorfull.html" class="blog-box">
                  ...
                  <div class="blog-post-content">
                    ...
                    <h6 class="blog-header">Lấy cảm hứng từ những câu chuyện ảnh, phỏng vấn và tài nguyên</h6>
                    <p class="mb-0">Bản thân công ty hỗ trợ khách hàng rất nhiều nhưng cũng đến lúc chúng xảy ra như vậy.</p>
                  </div>
                </a>
              </div>
      ...
      <section id="contact" class="section contact w-100">
        <div class="container">
          <h3 class="subtitle">Chạm Vào Và Di Chuyển</h3>
          <!-- Map -->
          <div class="row mt-5">
            <div class="col-lg-12"><div id="my-map" data-location-lat="21.572136" data-location-lng="105.663148" data-location-icon="assets/img/location-map.png"></div></div>
          </div>
          <div class="row mt-4">
            <!-- Address Info -->
              ...
              <div class="row">
                ...
                <div class="col-lg-12">
                  <div class="info-box">
                    ...
                    <div class="info-text">
                      <h5>Visit office</h5>
                      <small>Đại Từ, Thái Nguyên, Việt Nam</small>
                    </div>
                  </div>
                </div>
              </div>
